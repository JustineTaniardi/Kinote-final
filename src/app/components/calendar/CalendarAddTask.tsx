...
interface CalendarAddTaskProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit?: (data: CalendarAddTaskData) => void;
  onSuccess?: () => void;
}

export interface CalendarAddTaskData {
  title: string;
...
const CalendarAddTask: React.FC<CalendarAddTaskProps> = ({ isOpen, onClose, onSubmit, onSuccess }) => {
  ...
  const handleSubmit = () => {
    ...
    const payload: CalendarAddTaskData = {
      title,
      categoryId,
      priority,
      date,
